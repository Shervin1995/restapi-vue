...
<div class="col-12">
  <div class="card textcenter mt-3">
    ...
    <div class="card-body" :class="{'d-none' : toggle}">
      <form id="aptForm" @submit.prevent="getData" >
...
export default {
  ...
  methods: {
    getData: function(){
      ...
      this.aptData = {
        petName: this.aptData.petName,
        petOwner: this.aptData.ownerName,
        aptDate: this.aptData.aptDate + ' ' + this.aptData.aptTime,
        aptNotes: this.aptData.aptNotes
      }
      this.$emit('insert', this.aptData)
      this.aptData = [];
      this.toggle = true;
